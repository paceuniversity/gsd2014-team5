...
public class RetriveData extends AsyncTask<Void, Void, Void> {
	...
	DefaultHttpClient client = new DefaultHttpClient();
			HttpGet getRequest = new HttpGet("http://turbotri.com/gsd2014team5Top5.json"); //Creates the request to server asking for information 
			...
			String jsonData = builder.toString();
				...
				try {
					JSONObject json = new JSONObject(jsonData); //Creates the json object from the string created 
					Log.e("Json user:", json.getString("DishName").toString());
