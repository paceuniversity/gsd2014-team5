	...
	public String formatIngrediants(String unFormatedData){
		...
		while(dataPostion<unFormatedData.length()){
			...
			if(!unFormatedData.substring(dataPostion, dataPostion+1).equals(">")){
				...
				ret = ret.concat( tempStep + "<br>");
				stepCounter++;
				tempStep = "<b><big> &#8226; </b></big>";
